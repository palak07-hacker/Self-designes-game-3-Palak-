...
function preload(){
 ...
 trex_running = loadImage("trex.png");
  ...
  trexBendingImage = loadImage("trex bending.png");
...
function setup() {
  ...
  //trexBending = createSprite();
  
  bird = createSprite(50, 70, 20, 20);
...
function draw() {
  ...
  if (gameState===PLAY){
    ...
    if(keyIsDown("DOWN_ARROW")){
      trexBendingImage.scale = 0.1;
    trex.addImage(trexBendingImage);
    } 
